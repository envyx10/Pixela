...
const STYLES = {
  ...
  overlay:
    "absolute inset-0 bg-gradient-to-t from-pixela-dark/95 via-pixela-dark/80 to-transparent flex flex-col justify-end p-3 md:p-4 transition-opacity duration-300 opacity-0 group-hover:opacity-100 rounded-lg pointer-events-none group-hover:pointer-events-auto",
  ...
  recommendationOverlay:
    "absolute inset-0 flex flex-col justify-end p-4 transition-opacity duration-300 opacity-0 bg-gradient-to-t from-pixela-dark via-pixela-dark/70 to-transparent group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto",
  recommendationTitle:
